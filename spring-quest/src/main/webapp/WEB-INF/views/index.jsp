...
<body>
	...
	<label>Console</label>
	<div id="battleScreen"
		style=" display:none; position: absolute; font-size: 24px; border-style: dashed; background-color: white; width: 600px; height: 600px; z-index: 2; text-align: center;">
		...
		<div id="enemyDisplay" style="float: right;">
			...
			<div>
				<img id="enemyWeaponSpot1" src="/resources/images/all.png"
					height="150" width="100"> <img id="enemyWeaponSpot2"
					src="/resources/images/all.png" height="150" width="100">
			</div>
			<div>
				<img id="enemyWeaponSpot3" src="/resources/images/all.png"
					height="150" width="100"> <img id="enemyWeaponSpot4"
					src="/resources/images/all.png" height="150" width="100">
			</div>
		</div>
		...
		<div id="playerDisplay" style="float: left;">
			...
			<div>
				<img id="playerWeaponSpot1" src="/resources/images/all.png"
					height="150" width="100"> <img id="playerWeaponSpot2"
					src="/resources/images/all.png" height="150" width="100">

			</div>
			<div>
				<img id="playerWeaponSpot3" src="/resources/images/all.png"
					height="150" width="100"> <img id="playerWeaponSpot4"
					src="/resources/images/all.png" height="150" width="100">
		...
		<div style="float: right" id="playerHand">
			...
			<div>
				<img id="card7" src="/resources/images/all.png" height="250"
					...
					src="/resources/images/all.png" height="250" width="180"> <img
					id="card11" alt="image" src="/resources/images/all.png"
					height="250" width="180"> <img id="card12" alt="image"
					src="/resources/images/all.png" height="250" width="180">
		...
		<div id="acceptQuest" style="display: none">
			...
			<button id="acceptQuestParticipate"
				onclick="acceptQuestParticipate()">Yes</button>

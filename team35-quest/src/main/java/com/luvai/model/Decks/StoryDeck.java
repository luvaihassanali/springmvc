...
public class StoryDeck extends Decks {
	...
	public StoryDeck initRiggedStoryDeck(int deckId) {
		...
		if (deckId == 42 || deckId == 43) {
			...
			if (deckId == 43) {
				s_arr2[4] = CardList.Quest10; // should be 6
				s_arr2[3] = CardList.Event2;// should be event 1
				s_arr2[2] = CardList.Quest9;// event 8
				s_arr2[1] = CardList.Quest2; // tournament 1
				s_arr2[0] = CardList.Quest5; // quest7
			} else {
